---
title: "Quickstart"
description: "Get started with the Goodfire Ember SDK"
---
...
<a href="https://colab.research.google.com/drive/1KsU3wMmNfsjkU-6xWTRr7_784sBE1tm3?usp=sharing" target="_blank">
  <img
...
First, let's reset the model to its default state (without any feature edits)
...
<Accordion title="Contrastive Search">
